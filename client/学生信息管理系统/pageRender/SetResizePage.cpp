...
void SetResizePage(HWND hWnd) {
	...
	hResizeUsername = CreateWindow(TEXT("static"), TEXT("输入学号："),
		WS_CHILD | WS_VISIBLE | SS_CENTERIMAGE | SS_CENTER,
		rect.right / 2 - 270 /*x坐标*/, 260 /*y坐标*/, 140 /*宽度*/, 22 /*高度*/,
		hWnd /*父窗口句柄*/, (HMENU)ID_RESIZE_USERNAME /*控件ID*/, hInst /*当前程序实例句柄*/, NULL
	);
	...
	hResizeButton = CreateWindow(L"Button", L"查询", WS_VISIBLE | WS_CHILD | BS_PUSHBUTTON | BS_FLAT,
